...
--enc-sdsa-heads 8 8 8 0 0 0 --prob-q 0.0 --win-k 6.0 --weight-fn normal --weight-sigma 1 --weight-usage mult \
...
--label-smoothing 0.1 --weight-decay 0.0 --max-tokens 4096 --save-dir ../checkpoints/iwslt14_de_en/sdsa_wink --update-freq 1 --no-progress-bar \
