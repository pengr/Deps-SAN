...
@register_task('translation_pascal')  # <<改写>>,pascal模型的模块化
class TranslationPascalTask(FairseqTask):  # <<改写>>,pascal模型的模块化
    """
    ...
    def build_dataset_for_inference(self, src_tokens, src_lengths):
        return LanguagePascalDataset(src_tokens, src_lengths, self.source_dictionary)  # <<改写>>, 增加输入矩阵文本的后缀,便于添加sdsa和pascal矩阵;
