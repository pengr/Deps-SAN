...
def load_langpair_dataset(
    ...
    return LanguageSdsaMaxlenDataset(
...
@register_task('translation_sdsa_maxlen')  # <<改写>>,sdsa模型的模块化
class TranslationSdsaMaxlenTask(FairseqTask):  # <<改写>>,sdsa模型的模块化
    """
    ...
    def build_dataset_for_inference(self, src_tokens, src_lengths):
        return LanguageSdsaMaxlenDataset(src_tokens, src_lengths, self.source_dictionary)  # <<改写>>, 增加输入矩阵文本的后缀,便于添加sdsa和pascal矩阵;
