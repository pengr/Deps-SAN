...
def build_model(args, task):  # 通过args.arch和task选择所设定的models,此处为'transformer_wmt_en_de'模型
    return ARCH_MODEL_REGISTRY[args.arch].build_model(args, task) # 返回一个TransformerModel类,由与原始论文一致的Transfromer Encoder和Decoder组成
