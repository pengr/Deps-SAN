...
class MultiheadSdsaAttention(nn.Module):  # <<改写>>,sdsa模型的模块化
    ...
    def forward(
        ...
        if saved_state is not None:
            ...
            key_padding_mask = MultiheadSdsaAttention._append_prev_key_padding_mask(  # <<改写>>,sdsa模型的模块化
        ...
        attn_weights = MultiheadSdsaAttention.apply_sparse_mask(attn_weights, tgt_len, src_len, bsz) # <<改写>>,sdsa模型的模块化 # 此函数直接返回attn_weights
